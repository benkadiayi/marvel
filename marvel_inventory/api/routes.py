...
def create_car(current_user_token):
    ...
    cosmics_appeared_in = request.json['cosmics_appeared_in']
    super_power = request.json['super_power']
    user_token = current_user_token.token

    character = Character(name,description,cosmics_appeared_in,super_power,user_token = user_token )
...
def update_character(current_user_token,id):
    ...
    character.cosmics_appeared_in = request.json['cosmics_appeared_in']
